...
import 'model/fire_auth_error.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  Future<void> signUpUi() async {
    ...
    FireError status = await firebaseAuthController.signUp(
        email: email.text, password: password.text);
    if (status.test) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(status.message), backgroundColor: Colors.green,),);
    } else {
    ScaffoldMessenger.of(context).showSnackBar(
    ...
    // }else {
    //   ScaffoldMessenger.of(context).showSnackBar(
    //       SnackBar(content: Text('فشلت عملية تسجيل الحساب'),backgroundColor: Colors.red,));
    // }
